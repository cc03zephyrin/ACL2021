...
def train(trains, tests,   round = 0, do_val = False, writesummary = False):
	...
	with tf.Graph().as_default():
		...
		train_dataset = tf.data.Dataset.from_tensor_slices((Ds, As,  Parties, Ids))
		# train_dataset = train_dataset.shuffle(buffer_size = 100000)
		train_dataset = train_dataset.batch(FLAGS.batch_size)

		train_iterator = train_dataset.make_initializable_iterator()
		TrainD, TrainA, TrainParty,  TrainID= train_iterator.get_next()
