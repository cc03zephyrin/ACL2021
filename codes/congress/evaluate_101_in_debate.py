...
vs = 101.02# vamprior, adding masked labels, randomly masked
penalty = 1
rp = 5
...
def model(TrainD, TrainA, TrainThe, TrainID, TrainParty, TrainMask, Zbar = None, trained = True, reuse = False):
	trainf = True
	traint = True 
...
def train(trains, tests,  Zbar = None,  round = 0, do_val = False, writesummary = False):
	...
	with tf.Graph().as_default():
		...
		train_ops= model(TrainD, TrainA, TrainThe, TrainID, TrainParty, TrainMask, Zbar = Zbar)
