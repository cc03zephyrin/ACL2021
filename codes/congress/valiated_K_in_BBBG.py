...
vs = 115# vamprior, adding masked labels, randomly masked
penalty = 1
...
if __name__ == '__main__':
	...
	if FLAGS.tuning:
		...
		parameterdict = {"masks":[0.2, 0.08, 0.05, 0.03],  'Ks':[1, 2, 3, 5]} # epochs >=5
		...
		parametergrid = [[i, j] for i in parameterdict['masks'] for j in parameterdict['Ks']]
		print(parametergrid)
		all_MIs= []
		...
		for msk, k in parametergrid:
			...
			FLAGS.num_comp = k
			versname = "msk_{}_K_{}".format(msk, k)
